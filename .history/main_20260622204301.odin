...
main_menu_button:= Button{{main_menu.rect.x + 10, main_menu.rect.y + 10, 100, 60}, k2.RED, "Action"}
append(&main_menu.buttons, main)
...
y: f32 = 700
    ...
    //  k2.draw_text(button.label, {button.rect.x + 10, button.rect.y + 10}, 40, k2.BLACK)
    //  }
    fmt.println(button.rect.x, button.rect.y)
     }
