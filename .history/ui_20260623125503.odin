...
create_ui ::proc() -> (first_buttons: [dynamic; 5]Button, main: Menu) {
    ...
    action_button1:= Button{{main_menu.rect.x + 100, main_menu.rect.y + 500, 100, 50}, k2.LIGHT_YELLOW, "Harvest"}
    action_button2:= Button{{main_menu.rect.x + 200, main_menu.rect.y + 150, 100, 50}, k2.LIGHT_GREEN, "Logging"}
