...
if k2.mouse_button_went_down(.Left) {
    for &tile in tiles {
        if check_collisions(tile.rect, point) && player_ptr.action_points1 > 0{
            if player_ptr.action_points1 > 0 {
...
if k2.mouse_button_is_held(.Right) {
    ...
    draw_board(tiles)
    draw_ui(main_menu, buttons1, dice1_index, dice2_index, dice3_index, player.action_points1, player.action_points2, player.action_points3)
