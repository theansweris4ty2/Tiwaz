...
//     }
    ...
    for button in buttons1 {
        if k2.mouse_button_went_down(Right) check_collisions(button.rect, point) && player.action_points1 == 0 && player.action_points2 == 0 && player.action_points3 == 0{
...
player_action(tiles, player_ptr, buttons1, point)
