...
create_ui ::proc() -> (first_buttons: [dynamic; 5]Button, main: Menu) {
    ...
    action_button1:= Button{{main_menu.rect.x + 10, main_menu.rect.y + 300, 100, 50}, WHEAT_GOLD, "Harvest"}
    action_button2:= Button{{main_menu.rect.x + 1200, main_menu.rect.y + 300, 100, 50}, FOREST_GREEN, "Logging"}
    action_button3:= Button{{main_menu.rect.x + 250, main_menu.rect.y + 300, 100, 50}, SLATE, "Mining"}
