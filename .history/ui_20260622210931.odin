...
draw_ui ::proc(menu: Menu, buttons: [dynamic; 5]Button, index1: i32, index2: i32, index3: i32, action1: i32, action2: i32, action3: i32){
    ...
    k2.draw_text(main_menu.label, {main_menu.rect.x + 10, menu.rect.y + 10}, 70, k2.BLACK)
    k2.draw_text(fmt.tprintf("Action 1: {}", action1), {menu.rect.x + 50, main_menu.rect.y + 100}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("Action 2: {}", action2), {menu.rect.x + 50, main_menu.rect.y + 150}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("Action 3: {}", action3), {menu.rect.x + 50, main_menu.rect.y + 200}, 50, k2.BLACK)
