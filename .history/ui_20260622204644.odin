...
create_ui ::proc() -> (first_buttons: [dynamic; 5]Button, main: Menu) {
    ...
    main_menu_button2:= Button{{main_menu.rect.x + 300, main_menu.rect.y + 100, 100, 50}, k2.RED, "Action"}
    main_menu_button3:= Button{{main_menu.rect.x + 300, main_menu.rect.y + 100, 100, 50}, k2.RED, "Action"}
