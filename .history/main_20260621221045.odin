...
y: f32 = 700
    ...
    x += f32(100)
     ...
     k2.draw_text(fmt.tprintf("Action 1: {}", player.action_points1), {main_menu.rect.x + 300, main_menu.rect.y + 100}, 50, k2.BLACK)
      k2.draw_text(fmt.tprintf("Action 2: {}", player.action_points2), {main_menu.rect.x + 300, main_menu.rect.y + 150}, 50, k2.BLACK)
