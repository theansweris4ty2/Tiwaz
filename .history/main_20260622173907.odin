...
main::proc() {
player := Player{}
buttons1, buttons2 := create_ui()
k2.init(SCREEN_WIDTH, SCREEN_HEIGHT, "Tiwaz", {})
tiles := build_board()
defer delete(tiles)
dice_files :=[6]string{"assets/pipone.png", "assets/piptwo.png", "assets/pipthree.png", "assets/pipfour.png", "assets/pipfive.png", "assets/pip6.png"}
