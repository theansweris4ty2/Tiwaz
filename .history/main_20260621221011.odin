...
y: f32 = 700
    ...
    x += f32(100)
     ...
     k2.draw_text(fmt.tprintf("Action 1: {}", player.action_points1), {main_menu.rect.x + 300, main_menu.rect.y + 300}, 100, k2.BLACK)
      k2.draw_text(fmt.tprintf("Action 2: {}", player.action_points1), {main_menu.rect.x + 300, main_menu.rect.y + 300}, 100, k2.BLACK)
       k2.draw_text(fmt.tprintf("Action 3: {}", player.action_points1), {main_menu.rect.x + 300, main_menu.rect.y + 300}, 100, k2.BLACK)
