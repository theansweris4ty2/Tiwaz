...
draw_ui ::proc(menu: Menu, buttons: [dynamic; 5]Button, index1: i32, index2: i32, index3: i32, action1: i32, action2: i32, action3: i32){
    ...
    k2.draw_text(fmt.tprintf("Action 1: {}", action1), {main_menu.rect.x + 50, main_menu.rect.y + 100}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("Action 2: {}", action2), {main_menu.rect.x + 50, main_menu.rect.y + 150}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("Action 3: {}", player.action3), {main_menu.rect.x + 50, main_menu.rect.y + 200}, 50, k2.BLACK)
