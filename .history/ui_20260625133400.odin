...
draw_ui ::proc(menu: Menu, buttons: [dynamic; 5]Button, index1: i32, index2: i32, index3: i32, action1: i32, action2: i32, action3: i32, stats: Menu){
    ...
    k2.draw_text(fmt.tprintf("%d", player.crops, {stats.rect.x + 50, stat_buttons.rect.y + 100}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("%d", player.lumber), {stats.rect.x + 50, stats.rect.y + 150}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("%d", player.), {menu.rect.x + 50, menu.rect.y + 200}, 50, k2.BLACK)
