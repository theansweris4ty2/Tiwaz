...
create_ui ::proc() -> (first_buttons: [dynamic; 5]Button, main: Menu, stats: Menu) {
    ...
    buttons2: [dynamic; 9]Button
    stat_buttons: [dynamic; 9]Button
    ...
    action_button4:= Button{{main_menu.rect.x + 50, main_menu.rect.y + 35000, 110, 50}, WHEAT_GOLD, "Research"}
    action_button5:= Button{{main_menu.rect.x + 160, main_menu.rect.y + 300, 110, 50}, FOREST_GREEN, "Trade"}
    action_button6:= Button{{main_menu.rect.x + 270, main_menu.rect.y + 300, 110, 50}, SLATE, "Build"}
...
draw_ui ::proc(menu: Menu, buttons: [dynamic; 5]Button, index1: i32, index2: i32, index3: i32, action1: i32, action2: i32, action3: i32, stats: Menu, player: Player){
    ...
    k2.draw_text(menu.label, {menu.rect.x + 50, menu.rect.y + 10}, 70, k2.BLACK)
    k2.draw_rect_outline(stats.rect, stats.border, k2.BLACK)
    k2.draw_text(stats.label, {stats.rect.x + 50, stats.rect.y + 10}, 70, k2.BLACK)
