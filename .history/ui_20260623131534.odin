...
create_ui ::proc() -> (first_buttons: [dynamic; 5]Button, main: Menu) {
    ...
    action_button1:= Button{{main_menu.rect.x + 50, main_menu.rect.y + 300, 110, 50}, WHEAT_GOLD, "Harvest"}
    action_button2:= Button{{main_menu.rect.x + 160, main_menu.rect.y + 300, 110, 50}, FOREST_GREEN, "Logging"}
