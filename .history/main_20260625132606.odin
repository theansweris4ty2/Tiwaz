...
buttons1, main_menu, stats_menu := create_ui(player)
...
if k2.mouse_button_is_held(.Right) {
    ...
    draw_board(tiles)
    draw_ui(main_menu, buttons1, dice1_index, dice2_index, dice3_index, player.action_points1, player.action_points2, player.action_points3, stats_menu)
