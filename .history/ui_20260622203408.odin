...
create_ui ::proc() -> (first_buttons: [dynamic; 5]Button, second_buttons: [dynamic; 5]Button, menu) {
    ...
    main_menu:= Menu{{1370, 650, 420, 500}, {}, "Player Menu"}
    return buttons1, buttons2, main_menu
}
