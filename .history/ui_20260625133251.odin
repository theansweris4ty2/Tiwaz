...
draw_ui ::proc(menu: Menu, buttons: [dynamic; 5]Button, index1: i32, index2: i32, index3: i32, action1: i32, action2: i32, action3: i32, stats: Menu){
    ...
    // k2.draw_text(fmt.tprintf("%d", player.crops, {menu.rect.x + 50, menu.rect.y + 100}, 50, k2.BLACK)
    // k2.draw_text(fmt.tprintf("%d", player.lumber), {menu.rect.x + 50, menu.rect.y + 150}, 50, k2.BLACK)
    // k2.draw_text(fmt.tprintf("%d", action3), {menu.rect.x + 50, menu.rect.y + 200}, 50, k2.BLACK)
