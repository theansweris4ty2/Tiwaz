...
create_ui ::proc() -> (first_buttons: [dynamic; 5]Button, main: Menu, stats: Menu) {
    ...
    stats_menu : Menu = {{1370, 100, 420, 300}, stat_buttons, 10, "Stats Menu"}
    ...
    stat_button1:= Button{{stats_menu.rect.x + 200, stats_menu.rect.y + 100, 110, 50}, WHEAT_GOLD, "Crops"}
    stat_button2:= Button{{stats_menu.rect.x + 200, stats_menu.rect.y + 150, 110, 50}, FOREST_GREEN, "Lumber"}
    stat_button3:= Button{{stats_menu.rect.x + 200, stats_menu.rect.y + 200, 110, 50}, SLATE, "Ore"}
    stat_button4:= Button{{stats_menu.rect.x + 200, stats_menu.rect.y + 200, 110, 50}, BRICK, "Troops"}
...
draw_ui ::proc(menu: Menu, buttons: [dynamic; 5]Button, index1: i32, index2: i32, index3: i32, action1: i32, action2: i32, action3: i32, stats: Menu, player: Player){
    ...
    k2.draw_text(fmt.tprintf("%d", player.crops), {stats.rect.x + 150, stats.rect.y + 100}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("%d", player.lumber), {stats.rect.x + 150, stats.rect.y + 150}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("%d", player.ore), {stats.rect.x + 150, stats.rect.y + 200}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("%d", player.troops), {stats.rect.x + 150, stats.rect.y + 200}, 50, k2.BLACK)
