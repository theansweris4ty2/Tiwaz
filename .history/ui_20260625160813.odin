...
draw_ui ::proc(menu: Menu, buttons: [dynamic; 5]Button, index1: i32, index2: i32, index3: i32, action1: i32, action2: i32, action3: i32, stats: Menu, player: Player){
    ...
    k2.draw_text(fmt.tprintf("%d", player.crops), {stats.rect.x + 200, stats.rect.y + 75}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("%d", player.lumber), {stats.rect.x + 200, stats.rect.y + 125}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("%d", player.ore), {stats.rect.x + 200, stats.rect.y + 175}, 50, k2.BLACK)
    k2.draw_text(fmt.tprintf("%d", player.troops), {stats.rect.x + 200, stats.rect.y + 225}, 50, k2.BLACK)
