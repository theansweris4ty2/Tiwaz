...
create_ui ::proc() -> (first_buttons: [dynamic; 5]Button, main: Menu, stats: Menu) {
    ...
    stat_button1:= Button{{stats_menu.rect.x + 50, main_menu.rect.y + 300, 110, 50}, WHEAT_GOLD, "Farm"}
    stat_button2:= Button{{stats_menu.rect.x + 160, main_menu.rect.y + 300, 110, 50}, FOREST_GREEN, "Log"}
    stat_button3:= Button{{stats_menu.rect.x + 270, main_menu.rect.y + 300, 110, 50}, SLATE, "Mining"}
