...
create_ui ::proc() -> (first_buttons: [dynamic; 5]Button, main: Menu, stats: Menu) {
    ...
    stat_button2:= Button{{stats_menu.rect.x + 50, stats_menu.rect.y + 100, 110, 50}, FOREST_GREEN, "Lumber"}
    stat_button3:= Button{{stats_menu.rect.x + 50, stats_menu.rect.y + 150, 110, 50}, SLATE, "Ore"}
    stat_button4:= Button{{stats_menu.rect.x + 50, stats_menu.rect.y + 200, 110, 50}, BRICK, "Troops"}
