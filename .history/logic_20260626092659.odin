...
player_action :: proc(tiles: [dynamic]Tile, player_ptr: ^Player, buttons1: [dynamic; 5]Button){
...
if k2.mouse_button_went_down(.Left) {
    ...
    for button in buttons1 {
        if check_collisions(button.rect, point) && player_ptr.action_points1 == 0 && player_ptr.action_points2 == 0 && player.action_points3 == 0{
